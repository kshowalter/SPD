RAS127 = function(settings){
  ...
  if( system.roof.mean_height <= 20 ){
    uplift_pressure_min = table["≤ 20'"][index];
  } else if( system.roof.mean_height <= 25 ){
    uplift_pressure_min = table[">20' to ≤ 25'"][index];
  } else if( system.roof.mean_height <= 30 ){
    uplift_pressure_min = table[">25' to ≤ 30'"][index];
  } else if( system.roof.mean_height <= 35 ){
    uplift_pressure_min = table[">30' to ≤ 35'"][index];
  } else if( system.roof.mean_height <= 40 ){
    uplift_pressure_min = table[">35' to ≤ 40'"][index];
  } else {
