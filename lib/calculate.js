...
//  var f = settings.f;
  ...
  if(g.system.location.closest_station){
    system.location.low_temp = g.system.location.closest_station['Extreme min'];
    system.location.high_temp_max = g.system.location.closest_station['High Temp 0.4%'];
    system.location.high_temp = g.system.location.closest_station['High Temp 2% Avg.'];
  }
...
//////////////////////////////////////////////////////
  ...
  if( section_defined(active_system,  'location') ){
