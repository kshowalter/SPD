...
//  var f = settings.f;
  ...
  if( system.AC.voltage ) {
    system.AC.conductors = settings.data.opt.AC.conductors[system.AC.voltage];
...
//////////////////////////////////////////////////////
  ...
  //if( g.system.location.address && settings.system.location[name] !== settings.system_data.location[name] ) {
  //  settings.system_data.location.new_address = true;
  //  settings.system_data.location[name] = settings.system.location[name];
  //}
  //
  ...
  //      if( settings.system.location[name] !== settings.system_data.location[name]){
  //          settings.system_data.location.new_address = true;
  //      }
  //      settings.system_data.location[name] = settings.system.location[name];
  //  }
  ...
  if( section_defined(active_system, 'roof') ){
    ...
    if( system.roof.width1 < system.roof.width3 ){
      system.roof.least_horizontal_distance = system.roof.width1;
    } else {
