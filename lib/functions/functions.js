...
f.section_defined = function(system_id, section_name){
  //console.log('checking...', system_id, section_name);
  ...
  if( typeof active_system === 'string' ){
    ...
    //console.log(System_data.find({ system_id:active_system, section_name:section_name}));
    System_data.find({ system_id:active_system, section_name:section_name}).forEach(function(doc){
      //console.log( section_name, doc.value_name, doc.value);
      if( ! doc.value ) {
        defined = false;
        return;
      }
