mk_inputs = function(settings){
  ...
  settings.user_input = f.add_sections(state.inputs);
  ...
  settings.system = f.blank_copy(state.inputs); // make system section blank
  settings.system.array.module = {};

  //f.merge_objects( state.inputs, settings.system );
