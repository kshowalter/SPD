mk_inputs = function(settings){
  ...
  settings.inputs = {
    ...
    AC: {
      loadcenter_type: {
        options: ['240V/120V', '208/120V', '480/277V'],
      },
  ...
  for( i=15; i<=70; i+=1 ) settings.inputs.roof.width1.options.push(i);
  for( i=15; i<=70; i+=1 ) settings.inputs.roof.width2.options.push(i);
  for( i=15; i<=70; i+=1 ) settings.inputs.roof.width3.options.push(i);
  for( i=1; i<=25; i+=1 ) settings.inputs.roof.eave_wall_height.options.push(i);
