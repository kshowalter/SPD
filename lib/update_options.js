...
update_options = function( system_id, section_name, value_name){
  ...
  if(section_name === 'module' && value_name === 'make'){
    ...
    var loadcenter_type = getValue(section_name, value_name);
    var AC_options = settings.in.opt.AC.loadcenter[loadcenter_type];
    setOptions(section_name, 'voltage', AC_options);
  }
};
