...
rails = {
	...
	setModules: function()
	{
		//console.log(state.webpage.selected_modules);
		rails.tiles = [];
		var r = 1;
		var c = 1;
		while(state.webpage.selected_modules[r] !== undefined)
		{
			var row = [];
			while(state.webpage.selected_modules[r][c] !== undefined)
			{
				//console.log("state.webpage.selected_modules[%s][%s])", r, c, state.webpage.selected_modules[r][c]);
				row.push({ r:r-1, c:c-1, value:state.webpage.selected_modules[r][c], searched:false, rail:false });
				c++;
			}
		...
		//console.log("setTiles(state.webpage.selected_modules):", state.webpage.selected_modules);
