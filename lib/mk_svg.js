mk_svg = f.mk_svg = function(drawing, state){
  //console.log('displaying svg');
  //console.log('drawing_parts: ', drawing_parts);
  //container.empty()
  var drawing_state = state.drawing_state;
  var layer_attr = state.drawing_state.layer_attr;
  var fonts = state.drawing_state.fonts;

  var svg_document = document.createElementNS("http://www.w3.org/2000/svg", 'svg');
  //svg_document.setAttribute('width', state.drawing_state.size.drawing.w);
  //svg_document.setAttribute('height', state.drawing_state.size.drawing.h);
