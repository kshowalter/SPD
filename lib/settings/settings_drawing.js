state_drawing = function(state){
    ...
    state.pages.PDF.scale = {
        x: state.pages.PDF.w / state.drawing_state.size.drawing.w,
        y: state.pages.PDF.h / state.drawing_state.size.drawing.h,
    };

    if( state.pages.PDF.scale.x < state.pages.PDF.scale.y ) {
        state.page.scale = state.pages.PDF.scale.x;
    } else {
        state.page.scale = state.pages.PDF.scale.y;
    }
