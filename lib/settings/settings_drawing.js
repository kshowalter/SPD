settings_drawing = function(settings){
    ...
    loc.AC_disc = {
        ...
        y: loc.inverter.bottom_right.y - size.AC_disc.h/2 //-size.terminal_diam*4
    };
    ...
    // wire table
    loc.wire_table = {
        x: size.drawing.w - size.drawing.frame_padding*3 - 225,
        y: size.drawing.h - size.drawing.frame_padding*3 - 100,
    };
