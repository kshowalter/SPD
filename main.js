...
var system_container = k$('div').attr('id', system_container_id).appendTo(page);


var header_container = k$('div').appendTo(system_container);
...
// System setup
k$('div').html('System Setup').attr('class', 'section_title').appendTo(system_container);
var config_container = k$('div').attr('id', 'config_container').attr('class', 'section').appendTo(system_container);




var section_selector = $('<select>').attr('id', 'sectionSelector').appendTo(config_container.elem);
...
//var section_selector = k$('selector').setOptionsRef( 'config_options.section_options' ).setRef('status.active_section').attr('class', 'corner_title').appendTo(config_container);
...
k$('div').html('System Parameters').attr('class', 'section_title').appendTo(system_container);
var params_container = k$('div').attr('class', 'section').style('height', '150px').appendTo(system_container);
add_params(page_sections_params, params_container);

// drawing
var drawing = k$('div').attr('id', 'drawing').attr('class', 'section').appendTo(page);
...
var svg_container_object = k$('div').attr('class', 'drawing').style('clear', 'both').appendTo(drawing);
